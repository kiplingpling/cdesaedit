...
$query = "SELECT no_persil, kelas_desa, luas_terpindah, ipeda, dipindah, tahun_pindah, no_kohir_pindah, atasnama_pindah, klasifikasi FROM ketbaru where id='$_GET[id]' ORDER BY k_id ASC";
...
$childlaporan = "Data Perubahan Asset Pertanahan Desa Baru";
...
$header = array(
		...
		array("label"=>"Dipindah Seluas (m2)", "length"=>43, "align"=>"L"),
		...
		array("label"=>"Atas Nama", "length"=>38, "align"=>"L"),
