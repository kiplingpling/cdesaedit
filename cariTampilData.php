...
$query_Recordset1 = sprintf("SELECT * FROM download WHERE namapemilik LIKE %s ORDER BY namapemilik ASC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
$query_limit_Recordset1 = sprintf("%s LIMIT %d, %d", $query_Recordset1, $startRow_Recordset1, $maxRows_Recordset1);
$Recordset1 = mysql_query($query_limit_Recordset1, $eTanah) or die(mysql_error());
...
<table border="0" cellpadding="0" cellspacing="0" class="zebra-table">
  <tr>
    ...
    <td width="104" bgcolor="#3D91CB">NO KOHIR</td>
    <td width="245" bgcolor="#3D91CB">NAMA WAJIB PAJAK</td>
    <td width="316" bgcolor="#3D91CB">KETERANGAN</td>
    <td width="114" bgcolor="#3D91CB">TINDAKAN</td>
  </tr>
  <?php do { ?>
    <tr>
      ...
      <td><a href="http://localhost/cDesa/files/<?php echo $row_Recordset1['name'];?>"onmouseout="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image1','','img/btn/print-btn2.png',1)"><img src="img/btn/print-btn1.png" name="Image1" width="100" height="36" border="0" id="Image1" /></a></td>
    </tr>
