...
$query_Recordset1 = "SELECT * FROM download where id='$_GET[id]' ORDER BY id ASC";
...
$query = "SELECT k_id, no_persil, kelas_desa, luas_terpindah, metode, tahun, dari_no, dari_nama,  ke_no, ke_nama, klasifikasi FROM sejarahbaru where id='$_GET[id]' ORDER BY k_id ASC";
...
$childlaporan = "Data Sejarah Perubahan C Desa Baru";
...
$header = array(
		...
		array("label"=>"Dipindah Seluas (m2)", "length"=>33, "align"=>"L"),
		array("label"=>"Metode", "length"=>16, "align"=>"L"),
		array("label"=>"Tahun", "length"=>12, "align"=>"L"),
		array("label"=>"Dari No", "length"=>13, "align"=>"L"),
		array("label"=>"Dari Nama", "length"=>29, "align"=>"L"),
		array("label"=>"Ke No", "length"=>11, "align"=>"L"),
		array("label"=>"Ke Nama", "length"=>29, "align"=>"L"),
