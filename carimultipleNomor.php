...
<a href="support/PAC.pdf" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('bantuan','','img/btn/bantuan2.jpg',1)"><img src="img/btn/bantuan1.jpg" name="bantuan" width="240" height="40" border="0" id="bantuan" /></a><img src="img/apptemplate/footeras.jpg" width="240" height="73" /></div>
  ...
  <div class="col-md-10">
    ...
    <div style="color: #000; margin-left: 25px;">
      ...
      <h4 style="display: inline-block; font-size: 30px;"><b>CARI DATA</b></h4> Berdasarkan Nomor Kohir
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          <form id="form2" name="form2" method="get" action="tampilCariMultipleNomor.php" target="frame4">
          <div class="input-group" style="margin-right: 10px;">
            <input type="text" name="keyword" id="keyword" class="form-control" placeholder="Cari Data Berdasarkan Nomor" />
...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-primary">
      ...
      <iframe src="kelola.php" scrolling="yes" height="350" width="1075" frameborder="0" name="frame4"></iframe>
    </div>
  </div>
</div>
<div class="row">
  ...
  <div class="col-md-10 text-right">
    ...
    <a href="carimultipleNomor.php" class="btn btn-primary">
