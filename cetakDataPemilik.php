...
$query = "SELECT no, namapemilik, no_SPPT FROM download2 ORDER BY no ASC";
...
$judul = "Laporan";
$childlaporan = "Data Pemilik Letter C Desa Setelah 1997";
$footer = "Data ini dicetak menggunakan aplikasi cDesa";
$header = array(
		array("label"=>"No Kohir", "length"=>20, "align"=>"L"),
		array("label"=>"Nama Pemilik", "length"=>100, "align"=>"L"),
		array("label"=>"Nomor SPPT", "length"=>70, "align"=>"L")
	);
