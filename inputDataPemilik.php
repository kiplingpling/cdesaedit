...
<link href="plugin/css/sweetalert.min.css" rel="stylesheet" type="text/css">
...
<a href="support/PAC.pdf" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('bantuan','','img/btn/bantuan2.jpg',1)"><img src="img/btn/bantuan1.jpg" name="bantuan" width="240" height="40" border="0" id="bantuan" /></a><img src="img/apptemplate/footeras.jpg" width="240" height="73" /></div>
  ...
  <div class="col-md-10">
    ...
    <div style="color: #000; margin-left: 25px;">
      ...
      <h4 style="display: inline-block; font-size: 30px;"><b>MASUKKAN DATA</b></h4> Letter C Pertanahan

      <div class="row">
        <div class="col-md-7">
          <a href="inputData.php" class="btn btn-default">
            <i class="fas fa-list"></i> Data Letter C
          </a>
          <a href="inputDataPemilik.php" class="btn btn-primary">
            <i class="fas fa-list"></i> Data Pemilik Letter C Setelah 1997
          </a>
        </div>
        <div class="col-md-5">
          <form id="form2" name="form2" method="get" action="cariTampilData.php" target="frame1">
            <div class="input-group" style="margin-right: 10px;">
              <input type="text" name="keyword" id="keyword" class="form-control" placeholder="Cari Data C">
      ...
      <div class="row">
        <div class="col-md-7">
          <div class="panel panel-primary">
            ...
            <iframe src="tampilDataPemilik.php" scrolling="yes" height="425" width="610" frameborder="0" name="frame1"></iframe>
        ...
        <div class="col-md-5">
          <div class="panel panel-danger">
            <div class="panel-heading">
              <div class="panel-title"><i class="fas fa-plus"></i> Tambah Data</div>
            </div>
            <div class="panel-body">
            <form id="form1" name="form1" enctype="multipart/form-data" method="post" action="">
              <div class="form-group">
                <label>Nama Wajib Pajak</label>
                <input name="namapemilik" type="text" class="form-control" required />
              </div>
              <div class="form-group">
                <label>Nomor SPPT</label>
                <input name="no_SPPT" type="text" class="form-control" value="<?php echo $row_Recordset4['nosppt']; ?>" size="100%" required />
              </div>
              <div class="form-group">
                <label>Nomor Sertifikat</label>
                <input name="no_Sertificate"  type="text" class="form-control" required />
              </div>
            <button type="submit" name="submit" id="submit" class="btn btn-primary"><i class="fas fa-save"></i> Simpan</button>
            <button type="reset" name="reset" id="reset" class="btn btn-danger"><i class="fas fa-ban"></i> Batal</button>
...
function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
  ...
  switch ($theType) {
    case "text":
      $theValue = ($theValue != "") ? "'" . $theValue . "'" : "NOT NULL";
      break;    
    case "long":
    case "int":
      $theValue = ($theValue != "") ? intval($theValue) : "NOT NULL";
      break;
    case "double":
      $theValue = ($theValue != "") ? doubleval($theValue) : "NOT NULL";
      break;
    case "date":
      $theValue = ($theValue != "") ? "'" . $theValue . "'" : "NOT NULL";
      break;
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO `download2` (`no`, namapemilik, name,  no_SPPT, no_Sertificate) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['no'], "text"),
                       GetSQLValueString($_POST['namapemilik'], "text"),
                       GetSQLValueString($_POST['name'], "text"),                                GetSQLValueString($_POST['no_SPPT'], "text"),
...
$nosppt=addslashes($_POST['no_SPPT']);
$nosertificate=addslashes($_POST['no_Sertificate']);
$caption1=$_POST['caption'];
$link=$_POST['link'];
move_uploaded_file($temp,"files/".$name);
$insert=mysql_query("insert into download2(name, no, namapemilik, no_SPPT, no_Sertificate)values('$name','$Max_no','$nama','$nosppt','$nosertificate')");
if($insert){ 
...
echo "<script>
  ...
  echo "
<meta http-equiv='refresh' content='1.5;url=inputDataPemilik.php' />
  ";
// header("location:inputDataPemilik.php");
