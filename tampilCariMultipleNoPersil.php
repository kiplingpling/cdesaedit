...
$query_Recordset1 = sprintf("SELECT * FROM asset WHERE no_persil='$colname_Recordset1' ORDER BY `id` ASC", GetSQLValueString("%" . $colname_Recordset1 . "%", "text"));
...
<table border="0" cellpadding="0" cellspacing="0" class="zebra-table">
  <tr>
    ...
    <td width="14%" bgcolor="#E4E4E4"><strong>No Persil</strong></td>
    <td width="21%" bgcolor="#3D91CB">Kelas Desa</td>
  ...
  <?php do { ?>
    <tr>
      <td><strong><?php echo $row_Recordset1['no_persil']; ?></strong></td>
