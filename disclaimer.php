...
<div style="color: #000; margin-left: 25px;">
      ...
      <h4 style="display: inline-block; font-size: 30px;"><b>DISCLAIMER</b></h4>  Pasal Sanggahan

    <div class="row">
      <div class="col-md-9">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <div class="panel-title"><i class="fas fa-info"></i> Disclaimer</div>
          </div>
          <p class="headingchild" style="margin-left: 10px; margin-right: 5px">Semua isi dalam aplikasi cDesa ini dibuat dan  didistribusikan oleh DJ Computer Indonesia berupa teks, gambar dan segala  bentuk grafis hanya sebagai sistem informasi dan tidak diharapkan untuk tujuan  perdagangan saham dan atau transaksi lainnya.<br />
                        DJ Computer Indonesia sebagai pihak pengembang berupaya  keras untuk membuat sistem informasi mengenai dokumen pertanahan masyarakat  desa dalam hal ini adalah Letter C dapat digunakan dan dapat menyajikan  informasi yang seakurat mungkin untuk memudahkan penyimpanan, pengolahan, dan  perawatan dokumen. DJ Computer Indonesia tidak bertanggungjawab atas segala  kesalahan dan keterlambatan pembaruan isi data informasi, atau segala kerugian  yang timbul karena tindakan berkaitan penggunaan informasi yang disajikan.<br />
                        User dalam hal ini adalah dari pihak Desa berhak mengatur  dan menyunting isi dari informasi yang di simpan dalam cDesa ini agar tidak  merugikan orang atau pihak lain.<br />
                      Semua hasil karya sistem informasi yang dimuat dalam  aplikasi ini baik berupa teks, gambar atau segala bentuk grafis adalah menjadi  hak cipta DJ Computer Indonesia.</p>
        </div>
      </div>
      <div class="col-md-3">
