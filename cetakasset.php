...
$query = "SELECT k_id, no_persil, kelas_desa, luas_sisa, ipeda, diperoleh, tahun, no_kohir, atasnama, status, klasifikasi FROM asset where id='$_GET[id]' ORDER BY k_id ASC";
...
$childlaporan = "Data Asset Pertanahan Desa";
