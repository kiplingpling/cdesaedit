...
<body onload="MM_preloadImages('img/btn/home2.jpg','img/btn/input2.jpg','img/btn/user2.jpg','img/btn/disclaimerapp2.jpg','img/btn/bantuan2.jpg','img/btn/p2.jpg','img/btn/32.jpg','img/btn/41.jpg','img/btn/caridatamultiple2.jpg')">
...
<nav class ="navbar navbar-default" style="background: #0199CB; margin-bottom: 0;">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <!-- <a href="<?php echo $logoutAction ?>" class="navbar-link navbar-right" style="margin-right: 10px; margin-top: 5px;">
        <button type="button" class="btn btn-danger navbar-btn" id="btnLogout">
          <i class="fas fa-arrow-right"></i> Log Out
        </button>
      </a> -->
      <a href="#!" class="navbar-link navbar-right" style="margin-right: 10px; margin-top: 5px;" id="btnLogout">

        <button type="button" class="btn btn-danger navbar-btn tujuanLogout" id="<?php echo $logoutAction ?>">
          <i class="fas fa-arrow-right"></i> Log Out
        </button>
      </a>
...
<div id="conten-wrapper"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="567" valign="top"><p><span class="Heading"> DASHBOARD</span> <span class="headingchild">Control Panel</span></p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="26%"><img src="img/apptemplate/1.jpg" width="240" height="100" /></td>
          <td width="26%"><img src="img/apptemplate/2.jpg" width="240" height="100" /></td>
          <td width="26%"><img src="img/apptemplate/3.jpg" width="240" height="100" /></td>
          <td width="22%"><img src="img/apptemplate/4.jpg" width="240" height="100" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td></td>
          <td><div id="headwrap2"></div></td>
        </tr>
        <tr>
          <td width="73%" height="296" valign="top"><img src="img/apptemplate/homeimg.jpg" width="778" height="296" /></td>
          <td width="5%">&nbsp;</td>
          <td width="22%" valign="top" class="headingchild"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td align="right"><img src="img/apptemplate/templateimg.jpg" width="240" height="190" /></td>
                </tr>
                <tr>
                  <td><a href="tampilLearnAbout.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('learn','','img/btn/p2.jpg',1)"><img src="img/btn/p1.jpg" name="learn" width="240" height="35" border="0" id="learn" /></a></td>
                </tr>
                <tr>
                  <td><a href="support/PAC.pdf" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('contact','','img/btn/32.jpg',1)"><img src="img/btn/31.jpg" name="contact" width="240" height="35" border="0" id="contact" /></a></td>
                </tr>
                <tr>
                  <td><a href="tampilregister.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('reg','','img/btn/41.jpg',1)"><img src="img/btn/42.jpg" name="reg" width="240" height="35" border="0" id="reg" /></a></td>
                </tr>
              </table></td>
            </tr>
          </table></td>
        ...
        <tr>
          <td height="31" valign="top"><p class="h1"><span class="headingchild">© 2017 DJ Computer Indonesia. All Rights Reserved.</span></p></td>
          <td>&nbsp;</td>
          <td valign="top" class="headingchild">&nbsp;</td>
        </tr>
      </table></td>
  </tr>
</table>
...
<script>
  ...
  let tujuan       = document.getElementsByClassName('tujuanLogout');
  let tujuanLogout = tujuan[0].getAttribute('id');
  btnLogout.addEventListener('click', function () {
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        .then((logout) => { if (logout) {

        window.location.href = tujuanLogout;
        }});
      } else {
