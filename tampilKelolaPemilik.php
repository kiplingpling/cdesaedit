  ...
  <tr>
    <td height="569" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td><form id="form2" name="form2" method="get" action="tampilCariMultipleNamaPemilik.php" target="frame2">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
      ...
      <table width="400" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="tampilKelola.php" class="btn btn-default">Data Letter C</a></td>
          <td><a href="tampilKelolaPemilik.php" class="btn btn-primary">Data Pemilik Letter C Setelah 1997</a></td>
        </tr>
        <tr>
          <td width="116">&nbsp;</td>
          <td width="284">&nbsp;</td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="463" valign="top" align="right">    <iframe src="kelolapemilik.php" scrolling="yes" width="100%" height="400" frameborder="0" name="frame2"></iframe>
        ...
        <tr>
          ...
          <td><a href="cetakDataPemilik.php" class="btn btn-default" target="frame2">Cetak Data Pemilik</a></td>
        </tr>
        <tr>
          <td width="185">&nbsp;</td>
          <td width="135">&nbsp;</td>
