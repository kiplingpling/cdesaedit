  ...
  <div class="col-md-10">
    ...
    <div style="color: #000; margin-left: 25px;">
      ...
      <div class="row">
        <br />
        <div class="col-md-7">
          <div style="display: inline-block; font-size: 30px;"><b>DAFTAR PENGGUNA</b></div>
           Aplikasi
        </div>
        <div class="col-md-5">
          <form id="form2" name="form2" method="get" action="cariUser.php" target="frame3">
            <div class="input-group" style="margin-right: 10px;">
              <input type="text" name="keyword" id="keyword" class="form-control" placeholder="Cari Administrator">
        ...
        <div class="col-md-7">
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h2 class="panel-title"><i class="fas fa-list"></i> Data Pengguna Aplikasi</h2>
            </div>
            <iframe src="tampilUser.php" scrolling="yes" width="610" height="350" frameborder="0" name="frame3"></iframe>
          </div>
        </div>
        <div class="col-md-5">
          <div class="panel panel-danger" style="margin-right: 10px;">
            <div class="panel-heading">
              <h2 class="panel-title"><i class="fas fa-plus"></i> Tambah Pengguna</h2>
            </div>
          ...
          <form action="<?php echo $editFormAction; ?>" method="post" name="form3" id="form3">
            <div class="form-group">
              <label>ID</label>
              <input name="ID" type="text" class="form-control" value="" class="form-control" />
            </div>
            <div class="form-group">
              <label>Username</label>
              <input name="username" type="text" class="form-control" value="" class="form-control" />
            </div>
            <div class="form-group">
              <label>Password</label>
              <input name="password" type="password" class="form-control" value="" class="form-control" />
            </div>
            <button type="submit" name="submit" id="submit" class="btn btn-primary">
              <i class="fas fa-save"></i> Simpan
            </button>
            <button type="reset" name="reset" id="reset" class="btn btn-danger">
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form3")) {
  $insertSQL = sprintf("INSERT INTO `pengguna` (ID, username, password) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "userAuthentification.php";
  if ($Result1) {
  echo "<script>
  swal({
  title: 'Sukses!',
...
echo "<meta http-equiv='refresh' content='1;url=userAuthentification.php'>";
  }
  // if (isset($_SERVER['QUERY_STRING'])) {
