...
$insert=mysql_query("insert into assetbaru(name, id, k_id, no_persil, kelas_desa, luas_tersedia, luas_terpindah, luas_sisa, ipeda, diperoleh, tahun, no_kohir, atasnama, dipindah, tahun_pindah, no_kohir_pindah, atasnama_pindah, status, klasifikasi, nocdesa) values('$name','$nomor','$Max_id','$no_persil','$kelas_desa','$luas_tersedia','$luas_terpindah','$luas_sisa','$ipeda','$diperoleh','$tahun','$no_kohir','$atasnama','$dipindah','$tahun_pindah','$no_kohir_pindah','$atasnama_pindah','$status','$klasifikasi','$nocdesa')");
if($insert){
...
mysql_select_db($database_eTanah, $eTanah);
$query_Recordset1 = "SELECT * FROM assetbaru ORDER BY k_id ASC";
...
<table width="666" align="left">
    <tr valign="baseline">
      <td colspan="2" align="left" nowrap="nowrap"><p><strong>TAMBAHKAN ASSET TANAH</strong> <strong>BARU</strong></p></td>
    </tr>
    <tr valign="baseline">
    ...
    <tr valign="baseline">
      ...
      <td><select name="diperoleh">
        ...
        <option value="Sengketa">Sertifikat</option>
