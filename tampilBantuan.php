...
<div id="conten-wrapper"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="567" valign="top"><p><span class="Heading"> BANTUAN</span> <span class="headingchild">Support Center</span></p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>        </tr>
      </table>
      <p>&nbsp;      </p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="73%" height="296" valign="top"><iframe src="bantuan.php" name="frame3" width="778" height="400" scrolling="Yes" frameborder="0" id="frame3"></iframe></td>
          <td width="5%">&nbsp;</td>
          <td width="22%" valign="top" class="headingchild"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><a href="tampilBantuan.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('contact','','img/btn/32.jpg',1)"><img src="img/btn/31.jpg" name="contact" width="240" height="35" border="0" id="contact" /></a></td>
                </tr>
                <tr>
