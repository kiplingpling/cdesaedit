...
<a href="support/PAC.pdf" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('bantuan','','img/btn/bantuan2.jpg',1)"><img src="img/btn/bantuan1.jpg" name="bantuan" width="240" height="40" border="0" id="bantuan" /></a><img src="img/apptemplate/footeras.jpg" width="240" height="73" /></div>
  ...
  <div style="color: #000; margin-left: 25px;">
    <h4 style="display: inline-block; font-size: 30px;"><b>MASUKKAN DATA</b></h4>
     Letter C Pertanahan
    <div class="row">
      <div class="col-md-7">
        ...
        <a href="inputDataPemilik.php" class="btn btn-default">
      ...
      <div class="col-md-7">
        <div class="panel panel-primary">
          <div class="panel-heading">
            <h2 class="panel-title"><i class="fas fa-list"></i> Data Letter C</h2>
          </div>
          <iframe src="tampilData.php" scrolling="yes" height="425" width="610" frameborder="0" name="frame1"></iframe>
        </div>
      </div>
      <div class="col-md-5">
        <div class="panel panel-danger" style="margin-right: 10px;">
          <div class="panel-heading">
            <h2 class="panel-title"><i class="fas fa-plus"></i> Tambah Data</h2>
          </div>
        ...
        <form id="form1" name="form1" enctype="multipart/form-data" method="post" action="">
          ...
          <div class="form-group">
            <label>Upload Latter C</label>
            <input type="file" name="photo" id="photo" class="form-control" />
          </div>
          <div class="form-group">
            <label>Keterangan</label>
            <textarea name="keterangan" cols="100%" rows="4" class="form-control" id="keterangan" required></textarea>
          </div>
