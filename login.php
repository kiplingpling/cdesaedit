...
body {
	...
	background-image: url(img/apptemplate/giphy%20(1)
.gif);
	background-repeat: repeat;
	background-image: url(img/apptemplate/giphy%20(4)
.gif);
...
echo "<meta http-equiv='refresh' content='1;url=".$MM_redirectLoginSuccess."'>";
...
echo "<meta http-equiv='refresh' content='1.5;url=".$MM_redirectLoginFailed."'>";
