...
$query = "SELECT k_id, no_persil, kelas_desa, luas_terpindah, ipeda, dipindah, tahun_pindah, no_kohir_pindah, atasnama_pindah, klasifikasi FROM keterangan where id='$_GET[id]' ORDER BY k_id ASC";
...
$childlaporan = "Data Perubahan Asset Pertanahan Desa";
...
$header = array(
		...
		array("label"=>"Kelas Desa", "length"=>19, "align"=>"L"),
		array("label"=>"Dipindah Seluas (m2)", "length"=>40, "align"=>"L"),
		array("label"=>"Ipeda", "length"=>16, "align"=>"L"),
		array("label"=>"Dipindah", "length"=>16, "align"=>"L"),
		array("label"=>"Tahun", "length"=>12, "align"=>"L"),
		array("label"=>"Kohir", "length"=>13, "align"=>"L"),
