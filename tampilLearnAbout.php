...
<a href="support/PAC.pdf" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('bantuan','','img/btn/bantuan2.jpg',1)"><img src="img/btn/bantuan1.jpg" name="bantuan" width="240" height="40" border="0" id="bantuan" /></a><img src="img/apptemplate/footeras.jpg" width="240" height="73" /></div>
  ...
  <div class="col-md-10">
    ...
    <div style="color: #000; margin-left: 25px;">
      ...
      <h4 style="display: inline-block; font-size: 30px;"><b>ABOUT US</b></h4>  Tentang Kami

<div class="row">
  <div class="col-md-9">
    <div class="panel panel-primary">
      <div class="panel-heading">
        <div class="panel-title"><i class="fas fa-info"></i> Tentang Kami</div>
      </div>
      <iframe src="learnAbout.php" scrolling="yes" height="450" width="795" frameborder="0" name="frame3" style="margin-left: 10px; margin-top: 5px"></iframe>
    </div>
  </div>
  <div class="col-md-3">
