...
<body onload="MM_preloadImages('img/btn/home2.jpg','img/btn/input2.jpg','img/btn/user2.jpg','img/btn/disclaimerapp2.jpg','img/btn/bantuan2.jpg','img/btn/backupdata1.jpg')">
...
<div id="conten-wrapper"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="569" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td valign="bottom"><span class="Heading">KELOLA DATA</span> <span class="headingchild">Letter C Pertanahan</span></td>
        <td><form id="form2" name="form2" method="get" action="cariKelola.php" target="frame2">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="93%" valign="top"><div class="form-group input-group">
                ...
                <span class="input-group-btn">
                  <button class="btn btn-default" type="submit" name="Cari" id="Cari"><i class="fa fa-search"></i> </button>
                </span> </div></td>
            </tr>
          </table>
        </form></td>
      ...
      <table width="400" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="tampilKelola.php" class="btn btn-primary">Data Letter C</a></td>
          <td><a href="tampilKelolaPemilik.php" class="btn btn-default">Data Pemilik Letter C Setelah 1997</a></td>
        </tr>
        <tr>
          <td width="116">&nbsp;</td>
          <td width="284">&nbsp;</td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="463" valign="top" align="right">    <iframe src="kelola.php" scrolling="yes" width="100%" height="400" frameborder="0" name="frame2"></iframe>
            <p><table width="320" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="inputData.php" class="btn btn-primary">Tambahkan Data Induk</a></td>
          <td><a href="cetakDataInduk.php" class="btn btn-default" target="frame2">Cetak Data Induk</a></td>
        </tr>
        <tr>
          <td width="185">&nbsp;</td>
          <td width="135">&nbsp;</td>
