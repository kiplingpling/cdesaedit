...
mysql_select_db($database_eTanah, $eTanah);
$query_Recordset1 = "SELECT * FROM asset where id='$_GET[id]' ORDER BY k_id ASC";
$Recordset1 = mysql_query($query_Recordset1, $eTanah) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);
...
mysql_select_db($database_eTanah, $eTanah);
$query_Recordset3 = "SELECT * FROM keterangan where id='$_GET[id]' ORDER BY k_id ASC";
$Recordset3 = mysql_query($query_Recordset3, $eTanah) or die(mysql_error());
$row_Recordset3 = mysql_fetch_assoc($Recordset3);
$totalRows_Recordset3 = mysql_num_rows($Recordset3);

mysql_select_db($database_eTanah, $eTanah);
$query_Recordset4 = "SELECT * FROM sejarahbaru where id='$_GET[id]' ORDER BY k_id ASC";
...
<div id="TabbedPanels1" class="TabbedPanels">
  <ul class="TabbedPanelsTabGroup">
    ...
    <li class="TabbedPanelsTab" tabindex="0">Data Perubahan & Keterangan Asset Lama</li>
        <li class="TabbedPanelsTab" tabindex="0">Catatan Sejarah C Desa Terbaru</li>
  </ul>
 ...
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table border="1" cellpadding="3" cellspacing="0" width="100%">
        <tr>
          ...
          <td colspan="4" rowspan="2" bgcolor="#CCCCCC">Tindakan</td>
        </tr>
        <tr>
        ...
        <?php do { ?>
        <tr>
          <td><?php echo $row_Recordset1['k_id']; ?></td>
          ...
          <td><a href="http://localhost/cDesa/tampilCariMultipleNomor.php?keyword=<?php echo $row_Recordset1['no_kohir']; ?>"/><?php echo $row_Recordset1['no_kohir']; ?></a></td>
          ...
          <td><a href="http://localhost/cDesa/suratbukti/<?php echo $row_Recordset1['name']; ?>"><img src="img/btn/view.png" width="30" height="30" id="sprytrigger1" /></a></td>
          <td><a href="form_pindahData.php?k_id=<?php echo $row_Recordset1['k_id']; ?>&amp;&amp;id=<?php echo $row_Recordset1['id']; ?>" onClick="return confirm('Anda memilih perpindahan aset Lama. Apakah anda yakin ingin memindah aset <?php echo $row_Recordset1['no_persil']; ?> ?')"><img src="img/btn/pindah.png" alt="" width="30" height="30" id="sprytrigger2" /></a></td>
          <td><a href="form_pindahDataBaru.php?k_id=<?php echo $row_Recordset1['k_id']; ?>&amp;&amp;id=<?php echo $row_Recordset1['id']; ?>" onClick="return confirm('Anda memilih perpindahan aset Baru. Apakah anda yakin ingin memindah aset <?php echo $row_Recordset1['no_persil']; ?> ?')"><img src="img/btn/pindahbaru.png" alt="" width="30" height="30" id="sprytrigger3" /></a></td>
          <td><a href="hapusKet.php?k_id=<?php echo $row_Recordset1['k_id']; ?>&amp;&amp;id=<?php echo $row_Recordset1['id']; ?>" onClick="return confirm('Apakah anda yakin ingin menghapus <?php echo $row_Recordset1['no_persil']; ?> ?')"><img src="img/btn/del.png" alt="" width="30" height="30" /></a></td>
        </tr>
        <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
      </table>
      <div class="tooltipContent" id="sprytooltip3">Pindahkan Aset Baru</div>
<div class="tooltipContent" id="sprytooltip2">Pindahkan Aset Lama</div>
<div class="tooltipContent" id="sprytooltip1">Cetak Bukti</div>
<script type="text/javascript">
...
var sprytooltip3 = new Spry.Widget.Tooltip("sprytooltip3", "#sprytrigger3");
      ...
      <p align="right"><a href="tambahAsset.php?id=<?php echo $_GET[id]; ?>"><img src="img/btn/tambah.png" alt="" width="100" height="36" /></a> <a href="cetakasset.php?id=<?php echo $_GET[id]; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','img/btn/print-btn2.png',1)"><img src="img/btn/print-btn1.png" alt="" name="Image3" width="100" height="36" border="0" id="Image3" /></a></p>
      <p></p>
...
<?php if ($totalRows_Recordset3 > 0) { // Show if recordset not empty ?>
  <table border="1" cellpadding="3" cellspacing="0" width="100%">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_Recordset3['k_id']; ?></td>
        ...
        <td><a href="http://localhost/cDesa/tampilCariMultipleNomor.php?keyword=<?php echo $row_Recordset3['no_kohir_pindah']; ?>"/><?php echo $row_Recordset3['no_kohir_pindah']; ?></a></td>
...
<?php if ($totalRows_Recordset4 > 0) { // Show if recordset not empty ?>
  <table border="1" cellpadding="3" cellspacing="0" width="100%">
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC">Ke No Urut</td>
      <td bgcolor="#CCCCCC">Ke Nama</td>
    </tr>
    <?php do { ?>
      <tr>
        ...
        <td><a href="http://localhost/cDesa/tampilCariMultipleUrutPemilik.php?keyword=<?php echo $row_Recordset4['dari_no']; ?>"/><?php echo $row_Recordset4['dari_no']; ?></a></td>
        <td><?php echo $row_Recordset4['dari_nama']; ?></td>
        <td><a href="http://localhost/cDesa/tampilCariMultipleUrutPemilik.php?keyword=<?php echo $row_Recordset4['ke_no']; ?>"/><?php echo $row_Recordset4['ke_no']; ?></a></td>
        <td><?php echo $row_Recordset4['ke_nama']; ?></td>
        <td><?php echo $row_Recordset4['klasifikasi']; ?></td>
      </tr>
      <?php } while ($row_Recordset4 = mysql_fetch_assoc($Recordset4)); ?>
  </table>
        <p align="right"><a href="cetaksejarahbaru.php?id=<?php echo $_GET[id]; ?>" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image3','','img/btn/print-btn2.png',1)"><img src="img/btn/print-btn1.png" alt="" name="Image3" width="100" height="36" border="0" id="Image3" /></a></p>
  <?php } // Show if recordset not empty ?></div>
        </div>
</div>
<p>&nbsp;
