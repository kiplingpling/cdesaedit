...
<table border="0" cellpadding="0" cellspacing="0" class="zebra-table">
  <tr>
    ...
    <td width="16%" bgcolor="#3D91CB">NAMA DATA</td>
  ...
  <?php do { ?>
    <tr>
      ...
      <td width="16%"><div class="link_right"><a href="editDataPDF.php?id=<?php echo $row_Recordset1['id']; ?>">Perbarui Data</a></div></td>
      <td width="16%"><div class="link_right"><a href="edit.php?id=<?php echo $row_Recordset1['id']; ?>">Perbarui Nama</a></div></td>
      <td width="16%"><a href="deleteData.php?id=<?php echo $row_Recordset1['id']; ?>" onClick="return confirm('Apakah anda yakin ingin menghapus <?php echo $row_Recordset1['namapemilik']; ?> ?')"><img src="img/btn/delete.png" width="100" height="36" /></a></td>
