...
<body onload="MM_preloadImages('img/btn/home2.jpg','img/btn/input2.jpg','img/btn/user2.jpg','img/btn/disclaimerapp2.jpg','img/btn/bantuan2.jpg','img/btn/add2.png')">
...
<a href="support/PAC.pdf" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('bantuan','','img/btn/bantuan2.jpg',1)"><img src="img/btn/bantuan1.jpg" name="bantuan" width="240" height="40" border="0" id="bantuan" /></a><img src="img/apptemplate/footeras.jpg" width="240" height="73" /></div>
  ...
  <div class="col-md-10">
    ...
    <div style="color: #000; margin-left: 25px;">
      ...
      <h4 style="display: inline-block; font-size: 30px;"><b>CARI DATA</b></h4> Berdasarkan No Persil

      <div class="row">
        <div class="col-md-7">
          <a href="carimultiple.php" class="btn btn-primary">
        ...
        <div class="col-md-5">
          <form id="form2" name="form2" method="get" action="tampilCariMultipleNoPersil.php" target="frame4">
          <div class="input-group" style="margin-right: 10px;">
            <input type="text" name="keyword" id="keyword" class="form-control" placeholder="Cari Data Berdasarkan Nomor Persil" />
...
<div class="row">
  <div class="col-md-12">
    <div class="panel panel-primary">
      ...
      <iframe src="tampilEmpty2.php" scrolling="yes" height="350" width="1075" frameborder="0" name="frame4"></iframe>
    </div>
  </div>
</div>
<div class="row">
  <div class="col-md-2">
    <a href="cetakDataInduk.php" class="btn btn-primary" target="frame3">
      <i class="fas fa-print"></i> Cetak Data Induk
    </a>
  </div>
  <div class="col-md-10 text-right">
    ...
    <a href="carimultipleNomor.php" class="btn btn-default">
      <i class="fas fa-sort"></i> Berdasarkan Nomor
    </a>
    <a href="carimultipleKelasDesa.php" class="btn btn-default">
      <i class="fas fa-sort"></i> Berdasarkan Kelas Desa
    </a>
    <a href="carimultipleNoPersil.php" class="btn btn-primary">
      <i class="fas fa-sort"></i> Berdasarkan No Persil
    </a>
  </div>
</div>
